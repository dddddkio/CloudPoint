"""initial point_clouds

Revision ID: 77637f6ff629
Revises: 
Create Date: 2026-07-23 00:02:14.025457
"""
...
def upgrade() -> None:
    ...
    sa.Column('las_version', sa.String(length=16), nullable=True),
